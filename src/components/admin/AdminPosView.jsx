    ...
    <div className="container-fluid px-lg-4 py-4 fade-in-up">
      ...
      <div className="row g-4">
        ...
        <div className="col-lg-5 col-xl-4">
          <div className="glass-card p-3 border-glass shadow-lg sticky-top" style={{ top: "90px" }}>
            <h4 className="text-gold fw-bold fs-5 mb-3 d-flex align-items-center justify-content-between border-bottom border-glass pb-2">
              <span className="d-flex align-items-center gap-2">
                <ShoppingCart size={20} /> Comanda de Venta
              </span>
            ...
            <div className="overflow-auto mb-3" style={{ maxHeight: "250px" }}>
              {cartItems.length === 0 ? (
                <div className="text-center py-4 text-muted border border-dashed rounded p-3">
                  <ShoppingCart size={32} className="mb-2 text-gold opacity-50" />
                  <p className="small mb-0">Haz clic en los productos del catálogo para agregarlos a la comanda.</p>
                </div>
              ) : (
                cartItems.map((item) => (
                  <div
                    key={item.producto_id}
                    className="p-2 mb-2 rounded bg-dark bg-opacity-50 border border-glass d-flex align-items-center justify-content-between gap-2"
                  >
            ...
            <div className="mb-3 pt-2 border-top border-glass">
              <label className="form-label text-gold extra-small fw-bold mb-1">Cliente de la Venta:</label>
            ...
            {/* Tipo de Entrega */}
            <div className="mb-3">
              <label className="form-label text-gold extra-small fw-bold mb-1">Modalidad de Entrega:</label>
              <div className="btn-group w-100 mb-2">
                <button
                  type="button"
            ...
            <div className="mb-3">
              <label className="form-label text-gold extra-small fw-bold mb-1">Método de Pago:</label>
              ...
              {metodoPago === "efectivo" && (
                <div className="p-2 rounded bg-dark border border-glass">
                  <div className="d-flex align-items-center justify-content-between mb-1">
                    <span className="extra-small text-muted">Efectivo Recibido:</span>
                    <input
                      type="number"
                      step="0.01"
                  ...
                  <div className="d-flex align-items-center justify-content-between">
                    <span className="extra-small text-gold fw-bold">Cambio a Entregar:</span>
            ...
            <div className="mb-3">
              <label className="form-label text-gold extra-small fw-bold mb-1">Estado del Pedido:</label>
              <select
            ...
            <div className="p-3 rounded bg-dark border border-gold mb-3">
              ...
              {tipoEntrega === "delivery" && (
                <div className="d-flex justify-content-between small text-muted mb-1">
                  <span>Envío ({distanciaKm} km):</span>
                  <span>${costoEnvio.toFixed(2)}</span>
                </div>
              )}
              <div className="d-flex justify-content-between fs-5 fw-bold text-gold border-top border-glass pt-2">
